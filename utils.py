...
def define_default_flags(f):
    ...
    f.DEFINE_string('init_dist', "gaussian", "The distribution to use to initialize parameters (It is only implemented for training!)")
    ...
    f.DEFINE_boolean('truncated_init_dist', False, "Whether to truncate the size of the weights at initalization or not (whether to use truncated normal or not)")
