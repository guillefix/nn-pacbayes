#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Nov  6 14:52:07 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /users/guillefix/nn-pacbayes/./run_experiment_sgd_bayes --prefix adam_ce_chris_unnormalized_20000_512_2_128_adam_ce_1_ --m 20000 --dataset mnist --network fc --number_layers 2 --training --sigmaw 1.0 --sigmab 0.0357 --n_gpus 0 --pooling none --loss ce --optimizer adam --number_inits 600000 --ignore_non_fit --batch_size 128 --layer_width 512 --epochs_after_fit 1 --zero_one
