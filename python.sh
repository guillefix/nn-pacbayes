#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Jul 29 17:17:38 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 10 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/anaconda3/bin/python test_mpi.py
