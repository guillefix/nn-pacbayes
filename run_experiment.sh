#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Oct 25 18:10:17 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /users/guillefix/nn-pacbayes/./run_experiment --prefix max_new_pool_sweep --m 1000 --dataset KMNIST --network cnn --number_layers 4 --training --sigmaw 5.0 --sigmab 0.0 --label_corruption 0 --n_gpus 1 --compute_bound --pooling max --n_samples_repeats 0.1 --number_inits 1 --use_empirical_K --optimizer sgd --loss ce --intermediate_pooling 1111
