#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Oct 25 12:04:28 BST 2019      
date_start=`date +%s`
