#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Oct  7 21:58:05 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /users/guillefix/nn-pacbayes/./run_experiment --prefix new_arch_sweep_ --m 100 --dataset cifar --network resnet50 --number_layers 4 --training --sigmaw 1.414 --sigmab 0.0 --label_corruption 0 --n_gpus 0 --compute_bound --pooling none --n_samples_repeats 0.025 --number_inits 1 --use_empirical_K
