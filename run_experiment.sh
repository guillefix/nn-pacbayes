#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Oct  8 17:50:09 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /users/guillefix/nn-pacbayes/./run_experiment --prefix new_arch_sweep_ --m 100 --dataset cifar --network resnet50 --number_layers 4 --training --sigmaw 0.1 --sigmab 0.0 --label_corruption 0 --n_gpus 0 --compute_bound --pooling none --n_samples_repeats 0.25 --number_inits 1 --use_empirical_K
