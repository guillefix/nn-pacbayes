#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Jul 29 17:14:04 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 12 --mpi=pmi2 --mem-per-cpu=2000 nice -n 10 /mnt/zfsusers/guillefix/nn-pacbayes/./meta_script_arch_sweep vgg16 20000
