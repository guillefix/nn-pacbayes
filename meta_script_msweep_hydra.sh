#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jan 29 19:21:18 GMT 2020      
date_start=`date +%s`
...
export OMP_NUM_THREADS=20
 /usr/local/shared/slurm/bin/srun -u -N 1 --mpi=pmi2 --mem-per-cpu=10000 --ntasks-per-node=20 nice -n 10 /users/guillefix/nn-pacbayes/./meta_script_msweep_hydra mnist fc none 1
