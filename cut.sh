#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Oct 11 16:40:57 BST 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 nice -n 10 /usr/bin/cut -f1 /users/guillefix/nn-pacbayes/unique_prob_set_1e7_2_7_40_40_1_1.000000_0.000000_relu_fun_samples.txt | parallel -I{} ./meta_script {}
