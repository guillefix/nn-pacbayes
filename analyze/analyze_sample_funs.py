...
d = pd.read_csv("results/index_funs_probs_0_cnn_sample_sigmab0.0__mnist_cnn_4_none_0000.txt", header=None, names=["index","fun","ent"],delim_whitespace=True)
...
hist_data = plt.hist(d["T"], bins=101)
...
plt.savefig("T_dist_cnn_sample1e5__mnist_cnn_4_none_0000_sigmab0.0.png")
